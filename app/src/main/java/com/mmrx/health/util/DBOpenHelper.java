...
public class DBOpenHelper extends SQLiteOpenHelper {
     ...
     * getAllData()
     */
    public void add(String name,String password,String islogin){
        db.execSQL("INSERT INTO user (name,password,islogin) VALUES(?,?,?)",new Object[]{name,password,islogin});
    }
    ...
    public void updateLogin(String islogin){
        db.execSQL("UPDATE user SET islogin = ?",new Object[]{islogin});
    }

    public User getLogin(){
        System.out.println("tes3333333333333333333");
        User user = null;
        ...
        while(cursor.moveToNext()){
            ...
            user = new User(name,password,isLogin);
