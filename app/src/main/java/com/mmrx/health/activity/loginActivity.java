...
public class loginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        if (sp != null){
            mEtLoginactivityUsername.setText(sp.getString("username",null));
            mEtLoginactivityPassword.setText(sp.getString("password",null));
            mBtLoginactivityLogin.post(new Runnable(){
                @Override
                public void run() {
                    mBtLoginactivityLogin.performClick();
                }
            });
        }
        // 设置点击事件监听器
