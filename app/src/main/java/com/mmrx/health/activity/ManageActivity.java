...
import com.mmrx.health.fragment.NetNewsFragment;
...
import com.mmrx.health.util.DBOpenHelper;
...
public class ManageActivity extends BaseActivity implements OnClickListener {
    ...
    NetNewsFragment netNewsFragment;
...
//		beginTransaction.add(R.id.id_content, eatFragment).show(eatFragment).commit();
    ...
    private void initView() {
        ...
        tabs[4] = (LinearLayout) bottomBar.findViewById(R.id.bottom_bar_net);
        ...
        mBottomBn_net = (LinearLayout) findViewById(R.id.bottom_bar_net);
...
//        mBottomBn_bui.setOnClickListener(this);
    ...
    protected void onStart() {
        ...
        if (tag.equals(Constant.FRAGMENT_TAG_BUILD)) {
            ...
            setTabSelection(2);
        } else if (tag.equals(Constant.FRAGMENT_TAG_NET)) {
            setTabSelection(4);
        }
    }
    ...
    private void setTabSelection(int index) {
        ...
        switch (index) {
            ...
            case 3:
               ...
               /* if(buildFrament == null){
                ...
                if (newsFragment == null) {
                    ...
                    fragmentTransaction.add(R.id.id_content, newsFragment);
                } else {
            ...
            case 4:
                ...
                //设置bottom bar按钮的状态
                ((Button) mBottomBn_net.findViewById(R.id.bottom_bar_net_bn))
                        .setBackgroundColor(getResources().getColor(R.color.bottom_bar_pressed));
                ((Button) mBottomBn_net.findViewById(R.id.bottom_bar_net_bn))
                        .setTextColor(getResources().getColor(R.color.bottom_bar_text_pressed));
               /* if(buildFrament == null){
                ...
                break;*/
                if (netNewsFragment == null) {
                    netNewsFragment = new NetNewsFragment();
                    fragmentTransaction.add(R.id.id_content, netNewsFragment);
                } else {
                    fragmentTransaction.show(netNewsFragment);
                }
                break;
            default:
                break;
    ...
    private void hideAllFragment(FragmentTransaction transaction) {
        ...
        if (netNewsFragment != null)
            transaction.hide(netNewsFragment);
    }
    ...
    private String getFragmentTag() {
        switch (currentTabsIndex) {
            ...
            case 4:
                return Constant.FRAGMENT_TAG_NET;
        }
        return "";
    }
